...
public class BlockFile {
    ...
    /**
     * Write a int value into the file
     *
     * @param value the value you want to write into the file which is pointed by fp
     * @throws IOException
     */
     ...
     *
     * @param data the bytes you want to write
     * @param size the length of the data you want to write
     * @throws IOException
     */
    ...
    public int append_block(byte[] block) throws IOException {
        ...
        // position at the beginning of the new inserted block
