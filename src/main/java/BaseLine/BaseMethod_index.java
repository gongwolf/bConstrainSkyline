...
public class BaseMethod_index {
    private static int nn_dist;
    private final double range;
    private final int num_hotels;
...
//            int[] id_list = new int[]{462,472,791};
            ...
            for (int i = 0; i < query_num; i++) {
                ...
                int random_place_id = bs_index.getRandomNumberInRange_int(0, hotels_num - 1);
                Data queryD = bs_index.getDataById(random_place_id);
                queryList[i] = queryD;
            }
...
//        System.out.println("==========" + this.skyPaths.size());
        ...
        try (Transaction tx = this.graphdb.beginTx()) {
            ...
            Index idx = new Index(this.graph_size, this.degree, this.range, this.num_hotels, -1);
...
//                    }
        ...
        sb.append(" " + this.d_list_num / this.tmpStoreNodes.size());
