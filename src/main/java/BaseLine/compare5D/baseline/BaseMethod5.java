package BaseLine.compare5D.baseline;
...
public class BaseMethod5 {
    ...
    public BaseMethod5(int graph_size, String degree, double range, int hotels_num,int idx_num) {
        this.range = range;
        ...
        this.treePath = home_folder + "/shared_git/bConstrainSkyline/data/test_" + this.graph_size + "_" + this.degree + "_" + range + "_" + hotels_num+"_"+idx_num + ".rtr";
        this.dataPath = home_folder + "/shared_git/bConstrainSkyline/data/staticNode_" + this.graph_size + "_" + this.degree + "_" + range + "_" + hotels_num +"_"+idx_num +  ".txt";
    }
...
//            }
        ...
        sb.append(finalDatas.size() + " " + this.skyPaths.size() + "  " + add_counter + " ");
