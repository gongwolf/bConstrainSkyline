package BaseLine.compare5D.approximate.range;
...
public class BaseMethod_approx_index {
    ...
    public BaseMethod_approx_index(int graph_size, String degree, double distance_threshold, double range, int hotels_num, int idx_num) {
        r = new Random();
