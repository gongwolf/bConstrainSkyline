package BaseLine.compare5D.approximate.subpath;
...
public class BaseMethod_subPath {
    ...
    public BaseMethod_subPath(int graph_size, String degree, double distance_threshold, double range, int hotels_num,int idx_num) {
        r = new Random();
