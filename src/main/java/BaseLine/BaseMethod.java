...
//
//            if (d.getPlaceId() == this.checkedDataId) {
...
//                if (addToSkyline(final_costs)) {
//                    this.finalDatas.add(String.valueOf(d.getPlaceId()));
//                }
//                if (final_costs[0] >= d.distance_q) {
//                    constants.print(final_costs);
//                    constants.print(d.getData());
//                    System.out.println(d.distance_q);
//                }
            }
    ...
    public boolean addToSkyline(Result r) {
        ...
        if (skyPaths.isEmpty()) {
            ...
            for (; i < skyPaths.size(); ) {
                if (checkDominated(skyPaths.get(i).costs, r.costs) && skyPaths.get(i).p != null) {
